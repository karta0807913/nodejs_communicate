...
export function CreateReceiver(adapter: SocketAdapter, serialized: Serialization = new Serialization()) {
...
export function CreateSender(adapter: SocketAdapter, serialized: Serialization = new Serialization()) {
  if (adapter instanceof SocketAdapter) {
