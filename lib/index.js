...
const { CreateSender: CreateHttpSender, CreateReceiver: CreateHttpReceiver } = require("./http");
...
class CommunicateManager {
    ...
    async send_request(...args) {
        ...
        return this.sender.send_request(...args);
    }
...
module.exports = {
    ...
    CreateHttpReceiver, CreateHttpSender,
    Events, Adapter, Socket
};