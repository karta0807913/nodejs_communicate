...
const { MethodNotImplementError, SenderAlreadyClosedError, ConnectTimeOutError, UserInteruptError } = require("./Errors.js");
...
class Sender extends EventEmitter {
    ...
    async _connect(...args) {
        ...
        var error = new ConnectTimeOutError("connect time out");
        ...
        try {
            ...
            let connected = !!this.serialized.decode_response(result);
